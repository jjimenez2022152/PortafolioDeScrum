...
insert Estreno(pelicula_id, descripcionEstreno, fechaEstreno)
    ...
    insert Estreno(pelicula_id, descripcionEstreno, fechaEstreno)
	values(1, "Gran estreno: ScareFace 2", "2020/11/19");
    
select * from Estreno where idEstreno = 1;    
    
select * from Estreno;

insert into Estreno ( pelicula_id, descripcionEstreno, fechaEstreno) values (1, "Gran estreno: Megalodon 5", "2025-12-05");
...
SELECT 
    ...
    P.genero,
    P.sinopsis,
    E.descripcionEstreno,
    E.fechaEstreno
FROM Pelicula P
INNER JOIN Estreno E ON P.idPelicula = E.pelicula_id;
